...
namespace MistikLauncherUltra.Pages
{
    ...
    public class SettingsPage : Page
    {
        ...
        TextBox _tbUser = null!, _tbRam = null!;
        ...
        public SettingsPage(MainWindow main)
        {
            ...
            updateSp.Children.Add(PageHelpers.Lbl("🔄 Bulut Güncelleme Sistemi", 14, "#00A3FF", true));
            ...
            updateBtn.Margin = new Thickness(0, 10, 0, 0);
            updateBtn.Click += async (_, _) => {
                updateBtn.IsEnabled = false;
                updateBtn.Content = "Kontrol ediliyor...";
                updateStatusLbl.Text = "Bulut sunucusundan en son sürüm bilgileri alınıyor...";
